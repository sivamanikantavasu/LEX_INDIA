...
import { BookOpen, Mail, Lock, Eye, EyeOff, ArrowLeft, User, Phone, Building } from 'lucide-react';
      ...
      >
        ...
        <div className="glass-white rounded-2xl p-8 md:p-10 shadow-2xl border border-[#FF9933]/20">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-[#64748B]">Join as an educator to create content and conduct sessions</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div className="floating-input">
                <div className="relative">
                  <Building className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-[#64748B] z-10" />
                  <input
                    type="text"
                    placeholder=" "
                    ...
                    required
                  />
                  <label className="floating-label left-12">Institution/Organization</label>
                </div>
              </div>
            </div>
            ...
            <div className="floating-input">
              <div className="relative">
                <BookOpen className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-[#64748B] z-10" />
                <input
                  type="text"
                  placeholder=" "
                  ...
                  required
                />
                <label className="floating-label left-12">Highest Qualification</label>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              <input 
                type="checkbox" 
                id="terms"
                className="mt-1 w-4 h-4 rounded border-[#FF9933]/20 text-[#FF9933] focus:ring-[#FF9933]"
                required
              />
              <label htmlFor="terms" className="text-sm text-[#64748B]">
                I agree to the <a href="#" className="text-[#FF9933] hover:underline">Terms of Service</a> and <a href="#" className="text-[#FF9933] hover:underline">Privacy Policy</a>
              </label>
            </div>
